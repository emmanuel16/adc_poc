...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "audit_checklist@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "audit_checklist API";

        private String description = "audit_checklist API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "audit_checklist";
