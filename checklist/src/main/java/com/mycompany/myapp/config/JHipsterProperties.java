...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "checklist@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "checklist API";

        private String description = "checklist API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "checklist";
